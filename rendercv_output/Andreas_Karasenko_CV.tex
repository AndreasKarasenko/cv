...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Andreas Karasenko - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \section{Publications}
        ...
        \begin{tabularx}{\textwidth-0.4 cm-0.13cm}{K{0.2 cm} R{4.1 cm}}
            ...
            \mbox{Albert Smith}, \mbox{Andreas Karasenko}, \mbox{Jane Derry}, \mbox{Harry Tom}, \mbox{Anotherfirstname Andsurname}
            \vspace{0.10 cm}
